...
from PyQt6.QtWidgets import QStyleFactory, QDialog, QGridLayout, \
    QPushButton, QMessageBox, QLabel, QComboBox, QHBoxLayout, QDoubleSpinBox, QAbstractSpinBox
...
dentro da faixa aceitável.")
        ...
        self.kampsTargetLow_DoubleSpinBox.setButtonSymbols(QAbstractSpinBox.ButtonSymbols.NoButtons)
