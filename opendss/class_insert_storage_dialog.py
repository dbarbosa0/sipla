...
import opendss.class_storage_active_pow_dispmode_dialog
import opendss.class_storage_reactive_pow_dispmode_dialog
import opendss.class_storage_config_eff_curve
...
class C_Insert_Storage_Dialog(QDialog):  ## Classe Dialog principal
    def __init__(self):
        ...
        self.EffCurve = opendss.class_storage_config_eff_curve.C_Config_EffCurve_Dialog()
    ...
    def InitUI(self):
        ...
        self.DispModeActPowDialog = opendss.class_storage_active_pow_dispmode_dialog.C_Active_Pow_DispMode_Dialog()
        self.DispModeReactPowDialog = opendss.class_storage_reactive_pow_dispmode_dialog.C_Reactive_Pow_DispMode_Dialog()
